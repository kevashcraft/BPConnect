<template>
  ...
  <div id="wip_controls">
    <div class="item">
      <div class="ui wip category search">
...
export default {
  ...
  mounted: function() {
    $('.daterangepicker').daterangepicker({
      ...
      BPC.wip_controls.$set('daterange', daterange);
    ...
    $('.ui.wip.search').search({
      type: 'category',
      apiSettings: {
        method: 'post',
        url: BPC.routes['wip.search'] + '?q={query}',
      },
      ...
      onSelect: function (result, response) {
        ...
        switch (result.category) {
          case 'Tickets':
            this.filters.ticket_id = result.ticket_id;
            break;
        }
        BPC.wip.update();
      }.bind(this),
